package searchactivity.searchadapter;
...
public class SearchAdapter extends BaseAdapter implements Filterable {
    ...
    public SearchAdapter(List<String> list, Context context, FilterListener filterListener) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_ss = (TextView) convertView.findViewById(R.id.search_tv_musicname);
