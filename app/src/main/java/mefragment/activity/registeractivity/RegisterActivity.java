package mefragment.activity.registeractivity;
...
import com.example.master.tvf.MainActivity;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    @Bind(R.id.register_iv_headimage)
    ImageView register_iv_headimage;
    @Bind(R.id.register_tv_source)
    TextView register_tv_source;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        user = new User();
        register_tv_source.setOnClickListener(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RequestCode.REQUEST_CAMERA_CODE && resultCode == RESULT_OK && data != null) {//相机
            ...
            bitmap = BitmapUtils.zoom(bitmap,register_iv_headimage.getWidth(), register_iv_headimage.getHeight());
            ...
            //加载显示
            register_iv_headimage.setImageBitmap(bitmap);
            new DateFormat();
            ...
            Bitmap zoomBitmap = BitmapUtils.zoom(decodeFile, register_iv_headimage.getWidth(), register_iv_headimage.getHeight());
            //bitmap圆形裁剪
            Bitmap circleImage = BitmapUtils.circleBitmap(zoomBitmap);


            //加载显示
            register_iv_headimage.setImageBitmap(circleImage);
            //上传到服务器（省略）
            new DateFormat();
            imagename = DateFormat.format("yyyyMMdd_hhmmss",
                    Calendar.getInstance(Locale.CHINA)) + ".jpg";
    ...
    public void getGsonData(final User user){
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    @Override
                    public void onResponse(String response, int id) {
                        if(!response.equals("注册失败")){
                            Message message = Message.obtain();
                            Bundle bundle = new Bundle();
                            bundle.putString("username",user.getUsername());
                            bundle.putString("imagepath",response);
